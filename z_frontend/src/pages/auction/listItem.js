...
//     auctionDetail: "",
//     auctionDescription: "",
//     auctionLotType: "single", // default to single
//     auctionLotDetails: [{
//       auctionLotNumber: "",
//       productCategory: "",
//       lotWeight: "",
...
//     if (!formData.autcionTitle) newErrors.autcionTitle = "Auction title is required";
...
//                     onChange={(e) => handleLotChange(index, 'auctionLotNumber', e.target.value)}
...
const ListItemForm = () => {
  ...
  const validateForm = () => {
    ...
    const lotErrors = formData.auctionLotDetails.map((lot, index) => {
      ...
      if (!lot.productCategory) lotError.productCategory = "Category required";
      if (!lot.lotWeight) lotError.lotWeight = "Weight required";
      if (!lot.lotAuctionStartDate) lotError.lotAuctionStartDate = "Lot Auction Start Date is required";
      if (!lot.lotAuctionEndDate) lotError.lotAuctionEndDate = "Lot Auction End Date is required";
                ...
                <div key={index} className="px-4 pb-4 pt-1 border rounded-lg space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div className="md:col-span-2 grid grid-cols-1 gap-4">
                      <div className="space-y-2">
                        <label htmlFor="auctionDates" className="block text-sm font-medium text-gray-700">
                          Auction Dates
                        </label>
                        <div className="grid grid-cols-2 gap-4">
                          <input
                            ...
                            value={lot.lotAuctionStartDate}
                            onChange={(e) => handleLotChange(index, 'lotAuctionStartDate', e.target.value)}
                            className="w-full p-2 border rounded-md"
                          />
                          <input
                            id="endDate"
                            ...
                            value={lot.lotAuctionEndDate}
                            onChange={(e) => handleLotChange(index, 'lotAuctionEndDate', e.target.value)}
                            className="w-full p-2 border rounded-md"
                          />
                        </div>
                      </div>
