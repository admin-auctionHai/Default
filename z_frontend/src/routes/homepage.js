...
import HomePageImage from '../public/images/istockphoto-1439686281-612x612.jpg';
import AuctionWheel from './statsWheel';
import IndividualIntervalsExample from './corosaul';
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div id="sort-auction" className="mb-6">
        <div className="grid grid-cols-5 gap-4 bg-white p-3 rounded-lg shadow-md">
      ...
      <div className='flex w-full h-1/2'>
        ...
        <div className='w-1/3 h-1/3 bg-cyan-400'><AuctionWheel /></div>
      </div>
      <div className="rounded-lg shadow-lg p-6 min-h-[400px] flex items-center text-gray-500">
