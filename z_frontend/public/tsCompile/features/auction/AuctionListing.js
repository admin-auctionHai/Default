...
const AuctionListing = () => {
    ...
    const handleSearch = (value) => {
        ...
        const filtered = auctionData.filter(auction => {
            ...
            return (auction.id.toString().toLowerCase().includes(searchStr) ||
    ...
    return (_jsxs("div", { children: [_jsx("div", { id: "AdvanceAuctionForm", className: "flex w-4/5 mx-auto px-4 pt-8  justify-center items-center", children: _jsx(AuctionForm, {}) }), _jsx("div", { id: "list-table", children: _jsxs("div", { className: "mx-auto px-4 py-8", children: [_jsxs("div", { className: "w-4/5 mx-auto mb-4 flex items-center justify-between", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-800", children: "Auction List" }), _jsx("div", { className: "relative", children: _jsxs("div", { className: "relative", children: [_jsx("input", { type: "text", placeholder: "Search auctions...", value: searchTerm, onChange: (e) => handleSearch(e.target.value), className: "pl-10 pr-4 py-2 w-64 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" }), _jsx(Search, { className: "h-5 w-5 text-gray-400 absolute left-3 top-1/2 transform -translate-y-1/2" })] }) })] }), _jsx("div", { className: "w-4/5 mx-auto bg-white rounded-lg shadow", children: _jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [_jsx("thead", { className: "bg-gray-50", children: _jsxs("tr", { children: [_jsx("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Auction ID" }), _jsx("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Title" }), _jsx("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Publish Date" }), _jsx("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Submission Start Date" }), _jsx("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "View" })] }) }), _jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: filteredData.map((auction) => (_jsxs("tr", { className: "hover:bg-gray-50", children: [_jsx("td", { className: "px-6 py-4 text-left whitespace-nowrap text-sm text-gray-500", children: auction.id }), _jsx("td", { className: "px-6 py-4 text-left whitespace-nowrap text-sm font-medium text-gray-900", children: auction.title }), _jsx("td", { className: "px-6 py-4 text-left whitespace-nowrap text-sm text-gray-500", children: auction.publishDate }), _jsx("td", { className: "px-6 py-4 text-left whitespace-nowrap text-sm text-gray-500", children: auction.submissionStartDate }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: _jsx("button", { className: "text-blue-600 hover:text-blue-800", children: _jsx(Eye, { className: "h-5 w-5" }) }) })] }, auction.id))) })] }) })] }) })] }));
};
